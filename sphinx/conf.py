...
# -*- coding: utf-8 -*-
#
# drom documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'drom.tex', 'drom Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'drom', 'drom Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'drom', 'drom Documentation',
     author, 'drom', 'One line description of project.',
     'Miscellaneous'),
]
